...
So, I’ve made this project partially out of personal interest, and partially out of love. 

What is this project about?

This project was inspired after I picked up a field guide for wildflowers and other plants that grow on the side of the highway. It was formatted like a field guide, but written with such a tender passion for the small plants one might not notice while on the road. I’ve looked at other field guides before and never saw any flourishing text or storytelling attached to a plant. I spent some time flipping through the different field guides and reference books in my apartment and found that everyone wrote slightly differently about the same topic, whether it be plant, fungi, or animal. It made me wonder how many ways we could write about a single object, what other ideas or attachments could be made to something in nature that isn’t just an identifying description. 

At the most basic level, this project’s use is to understand the different ways that we know and describe mushrooms, a cultural property of an object. In reading through several field guides, pop science, non-fiction, and children's books, and putting them through tools like Voyant and Cytoscape, I’ve found a variety of ways to know a mushroom in the forest that’s more than its identifying features. For example, we can view it as a piece of culinary delight, examining the different words people use to describe flavor or ingredients often used in relation. Or as an important piece of folklore across time and different countries. We can examine how poison is described, the odd words that relate to death or distress in relation to a mushroom.
	
Data Collection

How were my mushrooms selected?

In total, this project focuses on eight mushrooms: chanterelles, morels, king boletes, chicken-of-the-woods, fairy rings, fly agarics, death caps, and turkey tails. While my selection is partially personal preference, all of these mushrooms can be found in the Northeast.  I took into consideration which mushrooms are popular to forage and which mushrooms are popular in art and literature. What mushrooms could someone easily, or not so easily, find in the woods near their house. 
How were my source materials collected?

My book selections are split into two parts: field guides and humanities-based literature. Field guides were mainly selected on a regional basis. I live, study, and collect fungi in the Northeastern region of the US. This project is based on what can be found from the top tip of Maine, all the way down to New Jersey. Therefore, nearly all of my field guides focus on this specific area.

Humanities based books are based on relation. I started my selection by referencing what books the local mushroom shop offered in their library area. I then checked out what books mycological/ nature societies recommended for reading outside of field guides. Finally, I went through all available books within the Minuteman library system for potential source uses. 

I aimed to find books that mentioned each of my selected mushrooms. Ideally, each book should mention each mushroom within my list. Within that, each source should have a minimum of two passages to pull from on each mushroom. While this was not always possible, I tried to minimize any issues by finding other sources with a larger selection of choice passages to make up for it. 
...
Non-Fiction: Mainly long form essays based on personal experience, as well as relationships to nature. Aspects of science are included in this writing, but more focused on the context of a mushroom. The goal of this book is to provide a different way of looking at a mushroom.
...
Economic Value: Passages that recognize a mushroom as monetary value. These paragraphs or sentences mention mushrooms in the context of money, capitalism, economics, costs, labor, and trade.

Naming: Passages that focus on how a mushroom is named, or what we lovingly call it. While this category may include how specific taxonomic names came to be, this is mainly structured around the cultural names given to a mushroom. From North America to Europe, Africa to Asia, names given by specific countries are covered here. 

Growing Space: Passages centered on the relationship between mushrooms and their environment. This category contains the specific trees that mushrooms enjoy, as well as the land surrounding them. No human interaction is found here. 

Medicinal:  Passages that focus on the use of mushrooms as a medical device. Includes eastern & western practices, as well as other non-traditional ways of using mushrooms to heal/aid in medical situations. 
